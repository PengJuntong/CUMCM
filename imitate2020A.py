...
def T_air(s):
    ...
    L0 = 25.0
    L1 = 30.5*5 + 4*4 +25 #193.5
    L2 = 30.5*6 + 4*5 +25 #228.0
    L3 = 30.5*7 + 4*6 +25 #262.5
    L4 = 30.5*9 + 4*8 +25 #331.5
    L5 = 30.5*11 + 4*10 +25 #400.5
    ...
    if s <= L0:
        ...
        return T4
    else:#if s >= L4 and s <= L5:
        return T4+(170-T4)*(s-L4)/(L5-L4)
